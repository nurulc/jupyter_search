...
You can manage all your notebook extensions from the `notebook.json` which is located in `~/.jupyter/nbconfig/`. For more information on how notebook extensions work please see [Notebook extensions | Jupyter](https://carreau.gitbooks.io/jupyter-book/content/notebook-extensions.html)
